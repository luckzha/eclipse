...
public class ItemCatController {
	 ...
	 * http://localhost:8091//item/cat/all/3/5
	 */
	@RequestMapping("/all/{page}/{rows}")  //名字任意需设置value值
	...
	@RequestMapping("/list")
	@ResponseBody
	public List<EasyUITree> findItemCat(@RequestParam(value="id",defaultValue="0",required=true)Long parentId){
